    ...
    <div class="reports-container">
        ...
        <?php if ($report_type === 'sales'): ?>
            ...
            <div class="data-table">
                <h3 style="padding: 20px; margin: 0; background: #f8f9fa;">Daily Sales</h3>
                <table>
                    <thead>
                        <tr>
                            <th>Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo strtoupper($sale['payment_methods']); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
        ...
        <?php elseif ($report_type === 'purchase'): ?>
            <div class="summary-cards">
                ...
                <div class="summary-card">
                    ...
                    <small><?php echo $summary['count']; ?> transactions</small>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <?php elseif ($report_type === 'stock'): ?>
            <div class="summary-cards">
                ...
                <div class="summary-card">
                    ...
                    <small>₱<?php echo number_format($cat['total_value'], 2); ?> value</small>
                </div>
                <?php endforeach; ?>
            </div>
