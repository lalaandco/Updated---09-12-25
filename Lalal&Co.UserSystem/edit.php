<?php
// Don't start session - header.php already did it
...
// Use existing connection from config.php (already included in header.php)
// Don't create a new PDO connection
if (!isset($conn)) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (!preg_match('/^[0-9]{4}$/', $postal_code)) {
        ...
        try {
            ...
            $stmt->bind_param("sssssssss", $name, $house_number, $street, $barangay, $city, $province, $postal_code, $contact, $_SESSION['email']);
...
// Get current user data using mysqli
