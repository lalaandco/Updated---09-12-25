<?php
session_start();
require_once 'productConfig.php'; // Add this line if not present
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    switch ($_POST['action']) {
        ...
        case 'get_cart':
            $cart = $_SESSION['cart'] ?? [];
            echo json_encode(['success' => true, 'cart' => array_values($cart)]);
            exit;
...
<body>
    ...
    <div class="cart-container">
        ...
        <div class="order-summary">
            ...
            <div class="payment-methods">
                ...
                <img src="data:image/jpeg;base64, " alt="Gcash" class="payment-icon">
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        class CartManager {
            ...
            saveCart() {
                // Save cart to localStorage and optionally sync with backend
            ...
            toggleWishlist(id) {
                ...
                // You could move item to wishlist and remove from cart
            }
            ...
            async addToCartFromAPI(productId) {
                try {
        ...
        // Example function to add items from other pages
        ...
        // Auto-sync with backend every 30 seconds (optional)
        // setInterval(() => cartManager.syncWithBackend(), 30000);
    </script>
