        ...
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="">
                ...
                <div style="background: #fff3cd; padding: 15px; border-radius: 8px; margin: 15px 0; ">
                    ...
                    <strong>Note:</strong> To manage stock quantities, please use the 
                    <a href="adminInventory.php" style="color: #007bff; text-decoration: underline;">Inventory Management</a> page.
                </div>
