...
// FIXED: Get all orders including 'delivered' status
$orders_query = "
    SELECT o.order_id, o.full_name, o.user_email, o.order_date, o.total_amount, o.status, o.payment_status
    FROM orders o
...
<head>
    ...
    /* ADDED: Tracking number conditional display */
    .tracking-info {
        margin-top: 10px;
        padding: 10px;
        background: #f8f9fa;
...
<body>
    ...
    <div class="invoice-container">
                ...
                <div class="billing-section">
                    ...
                    <div class="billing-info">
                        ...
                        <p><strong>Payment Status:</strong> 
                            <span class="status-badge status-<?php echo $order_data['payment_status']; ?>">
                                <?php echo strtoupper($order_data['payment_status']); ?>
                            </span>
                        </p>
                        <?php if (in_array($order_data['status'], ['shipped', 'delivered'])): ?>
                            <?php if (!empty($order_data['tracking_number'])): ?>
                                </div>
                            <?php else: ?>
                                <div class="tracking-info tracking-pending">
                                    <p style="margin: 0; color: #856404;">
                                        <strong>Tracking Number:</strong> Being processed
                                    </p>
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
        ...
        <?php elseif ($order_id && empty($order_items)): ?>
            <div class="empty-state">
                <i class='bx bx-error-circle'></i>
                <h3>No Items Found</h3>
                <p>This order has no items. Please contact support.</p>
            </div>
        <?php else: ?>
            <div class="empty-state">
